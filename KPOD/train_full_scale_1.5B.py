...
def main():
    ...
    config.model.student_model_name = "Qwen/Qwen2-1.5B"   # or "Qwen/Qwen1.5-4B"

    # Dataset
    config.data.dataset_name = "gsm8k"

    # Training hyperparameters for 4B model
    config.training.batch_size = 2          # Qwen-4B is much larger than Flan-T5
    config.training.gradient_accumulation = 8   # Effective batch size = 8
    config.training.lr_flan = 2e-5          # Much lower LR for 4B stability
